  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute left-0 mt-[17px] flex w-56 flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
...
const AppTopNav: React.FC = () => {
  ...
  const { toggleMobileSidebar } = useSidebar();                                             // mobile menu
  ...
  return (
    <header className="sticky top-0 flex w-full flex-col bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex items-center justify-between w-full gap-2 px-3 py-3 sm:gap-4 lg:px-6 lg:py-4">
        ...
        {/* <div className="hidden lg:block">                   //search bar and copied from AppHeader.tsx
          <form>
            <div className="relative">
      ...
      <nav className="hidden w-full px-6 py-2 border-t border-gray-200 lg:flex items-center gap-1 dark:border-gray-800">
        ...
        <TopNavLink
          ...
          item={{
            ...
            subItems: othersItems.flatMap((item) => item.subItems || []),
          }}
        />
      </nav>
    </header>
